...
const Header = ({ activeHeading }) => {
	...
	const [active, setActive] = useState(false);       //what for??
			...
			<div className={`${styles.section}`}>
				<div className="800px:h-[50px] 800px:my-[20px] 800px:flex items-center justify-between">
					...
					<div className="w-[50%] relative">
						...
						{/*//////////////////// need to understand this part not clear //////////////////////////////////////////////////////////////////////////////// */}
                ...
                <div className={`${active===true ? "shadow-sm fixed top-0 left-0 z-10":null
                    }transition 800px:flex items-center justify-between w-full bg-black h-[70px]`}>
